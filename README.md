...
Projeto acadêmico desenvolvido com o objetivo de praticar:
...
O Ouvidoria Connect simula o funcionamento de um sistema de ouvidoria real, permitindo o gerenciamento de sugestões, reclamações e elogios de maneira simples e eficiente.
